...
public class Drgs {
    ...
    public static class DataBean {
         ...
         * age : []
         * code : RU10
         * drg_models : {"model_field":[],"model_info":"无条件限制"}
         * id : 715
         * in_days : []
         * info_rule : [{"code":"RU10","name":"编码"},{"code":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","name":"名称"},{"code":"无条件限制","name":"计算模型"}]
         * inserted_at : 2019-06-15T23:50:31Z
         * is_cc : null
         * is_mcc : null
         * logs : []
         * mdc : R
         * model : drg_m07
         * model_info : {"model_field":[],"model_info":"无条件限制"}
         * name : 恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）
         * order_at : 736
         * out_result : []
         * query_table : rule_bj2019_drg
         * tab_rule : []
         * updated_at : 2019-12-25T02:09:52Z
         * versions : [{"code":"RU10","model_info":"无条件限制","name":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","version":"整合开发版(2019)"},{"code":"RU10","model_info":"无条件限制","name":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","version":"公立医院考核版(2019)"},{"code":"RU10","model_info":"无条件限制","name":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","version":"医院绩效考核版(2019)"},{"code":"RU10","model_info":"无条件限制","name":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","version":"CN-B-DRG(2018)"},{"code":"RU10","model_info":"无条件限制","name":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","version":"CN-T-DRG(2018)"},{"code":"RU10","model_info":"无条件限制","name":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","version":"BJ-DRG(2017)"},{"code":"RU10","model_info":"无条件限制","name":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","version":"BJ-DRG(2016)"},{"code":"RU10","model_info":"无条件限制","name":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","version":"BJ-DRG(2015)"},{"code":"RU10","model_info":"无条件限制","name":"恶性增生性疾病的支持性治疗（30天≤住院时间＜61天）","version":"CC-DRG(2015)"}]
         */

        public String adrg;
        public String code;
        public DrgModelsBean drg_models;
        public int id;
        ...
        @NoArgsConstructor
        @Data
        public static class DrgModelsBean {
            /**
             * model_field : []
             * model_info : 无条件限制
             */
            ...
            public List<String> model_field;
        }
